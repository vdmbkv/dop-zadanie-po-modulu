...
dict_students = dict.fromkeys(sorted_students, 'average score')
print(dict_students)

print([sumIlenOfAaron], [sumIlenOfBilbo], [sumIlenOfJohnny], [sumIlenOfKhendrik], [sumIlenOfSteve])

# как и сказано в примечании, я не стал присваивать каждому ключу в словаре студентов значение(средний балл)